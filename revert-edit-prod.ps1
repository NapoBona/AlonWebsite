...
$base = "https://alony-soundhealing.vercel.app"
$password = "harish2174"
$shekel = [char]0x20AA
$q = [char]0x22
...
"Restored name.en: $($restored.name.en)" | Out-File revert-out.txt -Encoding utf8
"Restored subtitle.he: $($restored.subtitle.he)" | Out-File revert-out.txt -Append -Encoding utf8
"Restored location: $($restored.location)" | Out-File revert-out.txt -Append -Encoding utf8
"Restored whatsappMessage.he: $($restored.whatsappMessage.he)" | Out-File revert-out.txt -Append -Encoding utf8
"Restored details.he length: $($restored.details.he.Length)" | Out-File revert-out.txt -Append -Encoding utf8
